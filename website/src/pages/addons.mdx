...
The interesting thing about `createSingleton()` is that it's fully dynamic. This
means the singleton tippy can have its props changed while it's showing as it
moves to the next target.

<TippySingleton delay={[200, 400]}>
  <Tippy content="Hello!" updateDuration={400}>
    <Button>Text</Button>
  </Tippy>
  <Tippy
    content="Hello, there!"
