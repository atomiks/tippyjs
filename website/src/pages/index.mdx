...
It provides the logic and styling involved in all types of elements that pop out
from the flow of the document and get overlaid on top of the UI — think
...
- <Icon src={lightning} alt="lightning" float /> <strong>Fast:</strong> high performance
  for low-end devices
