...
We can give it many different types of tooltips. Let's explore some of them
below!
...
<Demo>
  ...
  <Tippy placement="bottom" trigger="click">
...
<Demo>
  <Tippy theme="tippy-dark" animateFill={false}>
    <Button>Dark</Button>
  </Tippy>
  <Tippy theme="tippy-light" animateFill={false}>
    <Button>Light</Button>
  </Tippy>
  <Tippy theme="tippy-light-border" animateFill={false}>
    <Button>Light-border</Button>
  </Tippy>
  <Tippy theme="tippy-material" animateFill={false}>
...
```js
tippy('#myButton', {
  theme: 'tippy-light', // or 'tippy-light-border', 'tippy-google', ...
})
```
...
const instances = tippy('button', { updateDuration: 400 })
createSingleton(instances, { delay: [400, 800] })
```
...
<Demo>
  <Tippy content="Left" flip={false} placement="left">
    <Tippy content="Bottom" flip={false} placement="bottom">
      <Tippy content="Right" flip={false} placement="right">
        <Tippy content="Top" flip={false}>
          <Button
            style={{
