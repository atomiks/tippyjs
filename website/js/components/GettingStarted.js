...
export default () => (state, actions) => (
  <section class="section" id="getting-started">
    ...
    <p>
      Once it's loaded, you'll have access to the <code>tippy</code> module which will
...
`}
    ...
    <ul>
      <li>
        <code>tippy.all.js</code> is all dependencies (Tippy + Popper + CSS) in a single
    ...
    <p>
      There are also <code>.min</code> versions of the above, which means the file is
