...
[See the example here](/getting-started/#node-vs-browser).
...
Tippy adds this class to the `<body>` for iOS when there are any instances
showing:
...
has a side effect of allowing `mouse` related events to fire on "unclickable"
