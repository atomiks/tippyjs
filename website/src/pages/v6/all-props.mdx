...
is `appendTo: "parent"`. See [Accessibility](/accessibility/#interactivity) for
more information.
...
This allows screen reader software to announce the tippy content once the
reference element is in focus.
...
<Demo>
  <div style={{maxWidth: 250}}>
    This is a bunch of{' '}
    <Tippy inlinePositioning={true}>
      <span style={{outline: '2px solid black'}}>
        text and here is the actual element outlined
      </span>
    </Tippy>{' '}
    and some more text.
  </div>
