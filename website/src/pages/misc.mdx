...
Popper.js does not support smart inline element positioning. Here are a couple
of WIP solutions to view (they are not bug-free so use at your own risk!):

- [Split lines](https://codepen.io/atomiks/pen/GeBoyW)
- [Four placements](https://codepen.io/atomiks/pen/jjqbjy)

Experimental work is being done to make this a plugin in the future without
bugs.
