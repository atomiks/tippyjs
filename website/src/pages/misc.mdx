...
Popper.js does not support smart inline element positioning. You can view
[one technique here](https://codepen.io/atomiks/pen/GeBoyW?editors=0010), but
it's not completely bug-free yet. Alternative solutions are welcome.
