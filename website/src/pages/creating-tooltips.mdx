...
To give elements a tippy, call the `tippy()` function by passing in a CSS
selector, and give your reference element(s) a `data-tippy-content` attribute:
...
```js
// An element or an array of elements is valid
