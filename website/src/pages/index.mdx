...
Choose the best rect to use for inline elements.

<Demo>
  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec ultricies eget
  enim{' '}
  <Tippy content="inlinePositioning: true" inlinePositioning={true}>
    <Tippy
      content="inlinePositioning: true"
      placement="bottom"
      ...
      >
        ...
        >
          <strong style={{ color: 'black' }}>
            quis dapibus. Praesent posuere malesuada justo at efficitur. Aliquam
            nec quam fringilla,
          </strong>
        </Tippy>
      </Tippy>
  ...
  gravida nisl vitae, scelerisque leo. Phasellus porta commodo risus id
  interdum. Cras tempus diam ac molestie laoreet. Duis faucibus nec tellus at
  luctus. Etiam in orci laoreet, posuere orci ac, bibendum neque. Duis
  sollicitudin{' '}
  <Tippy content="inlinePositioning: 'cursor'" inlinePositioning="cursor">
    <Tippy
      content="inlinePositioning: 'cursor'"
      placement="bottom"
    ...
    >
      ...
      >
        ...
        >
          <strong style={{ color: 'black' }}>
            sollicitudin arcu, ac vestibulum erat. Nam vitae tristique mauris,
            in consectetur lectus. Etiam sollicitudin, neque eget aliquam
            suscipit, metus eros bibendum mi, eget maximus turpis libero nec
            quam. Etiam venenatis nisi ut
          </strong>
        </Tippy>
      </Tippy>
    </Tippy>
  </Tippy>{' '}
  dignissim porta. Praesent id felis feugiat, aliquam eros condimentum, maximus
  tortor.
</Demo>
